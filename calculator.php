...
$steps[$step_counter]["title"] = "Определяне на неизвестниет (относно количествата продукция, която се доставя от всеки доставчик до всеки клиент).";
...
while(true){
    ...
    if($current_s >= 0){
        ...
        $steps[$step_counter]["title"] = "<b><u>Проврка.</u></b>";
        $steps[$step_counter]["content"][] = "<br>";
        $steps[$step_counter]["content"][] = "<br>";
        $steps[$step_counter]["content"][] = "<br>";
